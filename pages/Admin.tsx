           ...
           <div className="space-y-6">
            ...
            <div className="space-y-2">
              {db.customTypes.map(type => (
                ...
                <div className="space-y-3">
                  {(['ru', 'en', 'es'] as const).map(l => ( <div key={l}> <label className="text-[8px] font-black uppercase text-slate-400 dark:text-slate-500 ml-2">{l} {ta.descriptionWord}</label> <textarea rows={8} className="w-full min-h-[9rem] bg-slate-50 dark:bg-black/40 border border-slate-100 dark:border-white/[0.08] rounded-2xl px-4 py-3 text-xs font-medium leading-relaxed focus:border-red-600 outline-none resize-y" value={editingItem.description?.[l] ||''}
